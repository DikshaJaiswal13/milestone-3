...
<link rel="stylesheet" type="text/css" href="./jsp/importDataStyle.css" />
<script
				...
				<div id="login-box">
					<div class="card">
						<div class="card-body">
							...
							<form:form method="POST" action="/importData" modelAttribute="idata" class="form" role="form" autocomplete="off">
								<div class="form-group row">
									...
									<div class="file-field medium col-lg-7">
										<div class="btn btn-rounded aqua-gradient float-left">
											<span class="glyphicon glyphicon-open"></span><input type="file"
								...
								<div class="form-group row">
									<!-- <br> <br> <br> <br>  -->
									<a href="myw3schoolsimage.jpg" download class="sample"> 
