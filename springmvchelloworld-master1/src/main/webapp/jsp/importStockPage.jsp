...
<html lang="en">
<head>
<title>Register Stock Exchange</title>
<meta charset="utf-8">
...
<link rel="shortcut icon"
	...
	type="image/x-icon" />
<link rel="stylesheet" type="text/css" href="./jsp/importStockPageStyle.css">
</head>
<body>
	...
	<div class="card">
     <div class="card-body">
      <h3 class="card-title text-center" align="center">Register
       Stock Exchange</h3>
      <hr>
      <form:form method="POST" action="/importStock" modelAttribute="istock" class="form" role="form" autocomplete="off">
       <div class="form-group row">
        <label class="col-lg-4 col-form-label form-control-label">Stock
         Exchange Name:</label>
        <div class="col-lg-8">
         <form:input class="form-control" type="text"
          path="stockExchangeName" placeholder="Stock Exchange Name"/>
        </div>
       </div>
       <div class="form-group row">
       ...
       <div class="form-group row">
        <label class="col-lg-4 col-form-label form-control-label">Contact
         Address:</label>
        <div class="col-lg-8">
         <form:input class="form-control" type="text" path="contactAddress"
