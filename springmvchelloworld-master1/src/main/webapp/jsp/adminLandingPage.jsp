...
<link rel="stylesheet" type="text/css" href="./jsp/adminLandingPageStyle.css" />
<script
...
<% User user=(User)request.getAttribute("user"); %>
 ...
 <div class="card">
 <div class="card-body">
  <img src="./jsp/profile1.jpg" alt="Avatar" style="width:100%; height:70%; border-radius:5px 5px 0px 0px;">
  
    <h4><b><%-- ${sessionScope.user.username } --%>John Doe</b></h4><hr>
   
   <!--  <p>Admin</p><hr>  -->
    <p class="style1">JohnDoe@gmail.com</p><hr>
    <p class="style1">9078447562</p>
  </div>
</div>
