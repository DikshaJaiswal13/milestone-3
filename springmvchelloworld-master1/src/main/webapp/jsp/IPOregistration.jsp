     ...
     <div class="card-body">
      ...
      <form:form method="POST" action="/ipoRegistration" modelAttribute="c1" class="form" role="form" autocomplete="off">
       <div class="form-group row">
        ...
        <div class="col-lg-7">
        <form:select class="form-control" path="companyCode" id="companyCode">
       ...
       <div class="form-group row">
        ...
        <div class="col-lg-7">
         <form:select class="form-control" path="stockExchange" id="stockExchange">
                        <option value="" disabled selected style="display: none;">Select Company Code</option>
       ...
       <div class="form-group row">
        ...
        <div class="col-lg-7">
         <form:input class="form-control" type="text" path="pricePerShare"
       ...
       <div class="form-group row">
        ...
        <div class="col-lg-7">
         <form:input class="form-control" type="text" path="noOfShares"
